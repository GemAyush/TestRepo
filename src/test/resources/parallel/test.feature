Feature: Automate Classic Website
  Scenario Outline: Test Things <example>
    ...
    Examples:
      | URL | example |
      | https://www.pimco.com/en-us/investments/etf/25-year-zero-coupon-us-treasury-index-exchange-traded-fund?r=Financial%20Intermediary&l=United%20States&s=True | Third Quarter Report |
